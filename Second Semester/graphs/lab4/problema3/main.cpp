...
/*
 * Să se  codeze  Huffman  un  text  dat.  La  construcția  arborelui  folosit  pentru  stabilirea  codurilor  Huffman,
 * prioritatea  la  alegerea  nodurilor  este  frecvența,  iar în  caz  de  egalitate,  se  alege  nodul în  al
 * cărui  subgraf  se găsește caracterul cu codul ASCII cel mai mic. Implementarea trebuie săfie eficientădin
 * punctul de vedere al memoriei folosite și al timpului de execuție.
 */

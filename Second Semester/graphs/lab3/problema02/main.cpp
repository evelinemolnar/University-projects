...
/*
 * Având dat un graf rar orientat ponderat calculați costul
 * minim de la fiecare vârf pânăla fiecare vârf  accesibil  din  acesta.
 * Implementarea  trebuiesăfie  eficientădin  punctul  de  vedere  al
 * memoriei folosite și al timpului de execuție. (Implementați algoritmul lui Johnson.)
 */

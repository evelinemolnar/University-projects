...
(
    ...
    admin_id INT FOREIGN KEY REFERENCES Admini(admin_id) ON UPDATE CASCADE ON DELETE CASCADE,
    check_in DATETIME,
    check_out DATETIME,
    status_id INT FOREIGN KEY REFERENCES StatusRezervare(status_id) ON UPDATE CASCADE ON DELETE CASCADE
